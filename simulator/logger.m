classdef logger < handle
    ...
    methods(Static)
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%
        function [data, times] = GetDesiredVelocities()
            [data, times] = logger.GetData(logger_signals.DesiredVelocity);
            data = cell2mat(cellfun(@(s)s', data, 'uni', 0));
        end
        %%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function [data, times, labels] = GetField(str)
            ...
            elseif contains_or(str, {'vel', 'speed'})
                ...
                [data_meas, times_meas] = logger.GetMeasuredVelocities();
                [data_des, times_des] = logger.GetDesiredVelocities();
