...
%                 disp(control_sp)
                ...
                ratio_3 = (pi / 2) * multirotor.State.ServoAngles(3) / 90;
                ratio_4 = (pi / 2) * multirotor.State.ServoAngles(4) / 90;
                ...
                actuator_trim(11) = obj.actuator_sp_11;
                actuator_trim(12) = obj.actuator_sp_12;
                ...
                tilt(1) = rad2deg(actuator_sp(5));
                tilt(2) = rad2deg(actuator_sp(6));
                tilt(3) = rad2deg(actuator_sp(7));
                tilt(4) = rad2deg(actuator_sp(8));

%                 deflections = [abs(actuator_sp(9)+actuator_sp(10))/2  actuator_sp(11) actuator_sp(12)];

                deflections = [actuator_sp(9)  actuator_sp(11) actuator_sp(12)];

                obj.actuator_sp_9  = actuator_sp(9);
                obj.actuator_sp_10 = actuator_sp(10);
                obj.actuator_sp_11 = actuator_sp(11);
                obj.actuator_sp_12 = actuator_sp(12);
